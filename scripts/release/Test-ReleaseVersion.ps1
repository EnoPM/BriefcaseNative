...
$sourceVersion=& (Join-Path $PSScriptRoot 'Read-Version.ps1') -ProjectRoot $project
if($sourceVersion -cne $Version){throw "Version $Version does not match VERSION ($sourceVersion)."}
