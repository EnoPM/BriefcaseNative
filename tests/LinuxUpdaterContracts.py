...
class Contracts(unittest.TestCase):
    ...
    def test_release_urls_and_offline(self):
        ...
        release['assets']=[];write_json(path,release)
        self.assertEqual(self.run_native('select',path,'Example/Framework','1.0.0'),'null')
        release=self.release(archive);write_json(path,release)
